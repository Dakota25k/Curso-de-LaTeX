...
No hay la negrita en la letra Times. Cómo instalar mtpro2.

Checkear la

Lucida fonts pesa 2megas.

Usar la columna de la derecha cuando se usa el paquete babel, sino usar la primera tabla.

Existe bibtex, biblatex y biber.

Tarea: Estudiar.

Checkear la tilde grave, tilde aguda y apostrofes.

Computer Modern es la fuente por defecto del LaTeX


La AMS vio que se puede sacar provecho LaTeX para matemática.

Los símbolos vienen en forma de comandos.

En la primera $ es un comando robusto $, 
$$ es mejor $$ que \[\]

Si eres ordenado, es mejor usar $$ $$, si eres desordenado, mejor usar \[\]

display equation quiere decir desplegado.