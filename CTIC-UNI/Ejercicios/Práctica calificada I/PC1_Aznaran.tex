%
% PC1_Aznarantex -- a tex source file.
%
...
\usepackage[utf8]{inputenc}														% Use it only if you have the version of texlive 2018 or higher
...
\usepackage{enumitem}
\usepackage[lmargin=2cm, rmargin=1.5cm, tmargin=2cm, bmargin=1.5cm]{geometry}
