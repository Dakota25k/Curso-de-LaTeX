...
\begin{center}
	\includegraphics{a}
\end{center}
\( {\int }_{2}^{3}xdx \)%nota es posible que te genere error ya que la ubicación del archivo con el que fue creado no está en tu pc. Para solucionar este error, clic en asistentes, luego insertar gráfico, seleccionar el archivo y clic en OK. ¡Gracias!
